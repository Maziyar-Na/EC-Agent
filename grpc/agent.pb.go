...
type TriggerPodDeploymentWatcher struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *TriggerPodDeploymentWatcher) Reset() {
	*x = TriggerPodDeploymentWatcher{}
	if protoimpl.UnsafeEnabled {
...
func (x *TriggerPodDeploymentWatcher) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TriggerPodDeploymentWatcher) ProtoMessage() {}

func (x *TriggerPodDeploymentWatcher) ProtoReflect() protoreflect.Message {
	mi := &file_agent_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TriggerPodDeploymentWatcher.ProtoReflect.Descriptor instead.
func (*TriggerPodDeploymentWatcher) Descriptor() ([]byte, []int) {
	return file_agent_proto_rawDescGZIP(), []int{2}
}

func (x *TriggerPodDeploymentWatcher) GetNamespace() string {
	if x != nil {
		return x.Namespace
	}
	return ""
...
var file_agent_proto_rawDesc = []byte{
	...
	0x49, 0x44, 0x22, 0x3b, 0x0a, 0x1b, 0x54, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x50, 0x6f, 0x64,
	...
	,
...
var file_agent_proto_goTypes = []interface{}{
	...
	(*TriggerPodDeploymentWatcher)(nil), // 2: agentcomm.TriggerPodDeploymentWatcher
}
var file_agent_proto_depIdxs = []int32{
	0, // 0: agentcomm.Handler.ReqConnectContainer:input_type -> agentcomm.ConnectContainerRequest
	2, // 1: agentcomm.Handler.ReqTriggerWatcher:input_type -> agentcomm.TriggerPodDeploymentWatcher
	1, // 2: agentcomm.Handler.ReqConnectContainer:output_type -> agentcomm.ConnectContainerReply
	2, // 3: agentcomm.Handler.ReqTriggerWatcher:output_type -> agentcomm.TriggerPodDeploymentWatcher
...
func file_agent_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_agent_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TriggerPodDeploymentWatcher); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
